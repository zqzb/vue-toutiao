...
export default {
	getNews({commit,state},pay) {
		if(pay.kind && pay.flag) {
			jsonp('http://m.toutiao.com/list/?tag='+pay.kind+
				'&ac=wap&count=20&format=json_raw&as=A125A8CEDCF8987&cp=58EC18F948F79E1&min_behot_time='+
				paraeInt((new Date().getTime())/1000),function(err,res){
